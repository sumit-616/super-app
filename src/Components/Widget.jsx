    ...
    <div className="h-screen w-[100vw] bg-black overflow-y-auto" style={{ width: contentWidth }}>
      <div className='mx-6 mt-8 mb-2'>
        <div className="h-[120vh] grid md:grid-cols-3 md:grid-rows-5 sm:grid-cols-1 gap-x-6 gap-y-4">
            ...
            <div className='flex flex-col px-8 gap-4'>
              ...
              <div className='grid md:grid-cols-2 gap-2'>
                {selectedGenres?.map((genre, index) => (
                  <div key={index}>
                    <div className='text-white rounded-2xl text-md h-8 bg-[#9F94FF] flex justify-center items-center'>{genre}</div>
                  </div>
                ))}
              </div>
            </div>
          ...
          {/* notes second one */}
          <div className="flex flex-col gap-4 bg-[#F1C75B] row-span-3 p-8 rounded-2xl">
